...
namespace XLAF.Public
{
    ...
    public class MgrScene : MonoBehaviour
    {
        ...
        public static void GotoScene (string sceneName, SceneAnimation anim, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, object data, SceneAnimation anim, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, SceneAnimation anim, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        // 5 group parameter => 9
        public static void GotoScene (string sceneName, object data, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, object data, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, object data, SceneAnimation anim, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        // 6 group parameter => 2
        public static void GotoScene (string sceneName, object data, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void GotoScene (string sceneName, object data, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
