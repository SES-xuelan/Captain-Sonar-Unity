...
namespace XLAF.Public
{
    ...
    public class MgrDialog : MonoBehaviour
    {
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float eachSceneTime)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float oldSceneTime, float newSceneTime)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float eachSceneTime)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float eachSceneTime, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        // 5 group parameter => 9
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float oldSceneTime, float newSceneTime, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float eachSceneTime, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        // 6 group parameter => 2
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void ShowDialog (string sceneName, object data, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        // 2 group parameter => 5
        public static void HideDialog (string sceneName, SceneAnimation anim)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        // 3 group parameter => 9
        public static void HideDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float eachSceneTime)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float eachSceneTime, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float oldSceneTime, float newSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
        ...
        public static void HideDialog (string sceneName, SceneAnimation anim, float eachSceneTime, XLAF_Tween.EaseType ease, Action cb)
        {
            SceneParams sp = new SceneParams ();
            sp.sceneName = sceneName;
            sp.anim = anim;
